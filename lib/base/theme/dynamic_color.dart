...
const _roleForToken = <ColorToken, String>{
  // Sidebar, bottom bar and controls take the scheme's three container
  // roles, so a system palette spreads across the app like a flavour does.
  ColorToken.pageBackground: 'surface',
  ColorToken.panel: 'surface_container_low',
  ColorToken.sidebar: 'primary_container',
  ColorToken.bottom: 'tertiary_container',
  ColorToken.menu: 'surface_container_high',
  ColorToken.button: 'secondary_container',
  ColorToken.searchField: 'surface_container_high',
  ColorToken.selectedItem: 'surface',
...
Palette paletteFromColorScheme(ColorScheme scheme) => {
  ...
  ColorToken.sidebar: scheme.primaryContainer,
  ColorToken.bottom: scheme.tertiaryContainer,
  ColorToken.menu: scheme.surfaceContainerHigh,
  ColorToken.button: scheme.secondaryContainer,
  ColorToken.searchField: scheme.surfaceContainerHigh,
  ColorToken.selectedItem: scheme.surface,
  ...
  ColorToken.volumeBar: scheme.tertiary,
